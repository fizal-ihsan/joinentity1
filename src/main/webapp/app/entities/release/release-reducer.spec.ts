...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './release.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RELEASE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RELEASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RELEASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RELEASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RELEASE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RELEASE actions', async () => {
      const expectedActions = [
        {
